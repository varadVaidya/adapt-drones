...
class TrajectoryEncoder(nn.Module):
    ...
    def __init__(self, input_size, output_size=16):
        ...
        self.n_filters_1 = 8
        self.conv1 = nn.Conv1d(1, self.n_filters_1, kernel_size=3, stride=2)
        self.n_filters_2 = 4
        self.conv2 = nn.Conv1d(
            self.n_filters_1, self.n_filters_2, kernel_size=3, stride=2
        )
        self.attn = nn.Linear(self.n_filters_2, 1)
        self.out_proj = nn.Linear(self.n_filters_2, output_size)
